      ...
      <Link href={href} className="group block h-full rounded-[14px] overflow-hidden border border-[#60A5FA]/20 transition-all duration-300 hover:-translate-y-1 hover:shadow-[0_20px_60px_rgba(37,99,235,0.15)]">
        <div className="relative w-full h-full min-h-[300px] md:min-h-[350px] lg:min-h-[380px]">
          ...
          <div className="absolute bottom-4 left-4 right-4 z-20">
            ...
            <div className="bg-white rounded-[12px] w-[40px] h-[40px] flex items-center justify-center group-hover:w-[70px] group-hover:bg-white/90 transition-all duration-300 ease-in-out hover:shadow-[0_0_20px_rgba(255,255,255,0.4)]">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="22"
                height="22"
                className="bi bi-arrow-right-short text-[#0F172A] transition-colors"
                viewBox="0 0 16 16"
                fill="currentColor"
              >
                <path
      ...
      <div className="relative glass-card-dark-transparent rounded-[14px] p-4 md:p-5 h-[200px] sm:h-[220px] md:h-[240px] flex flex-col justify-between border border-[#60A5FA]/20 transition-all duration-300 hover:-translate-y-1 hover:shadow-[0_20px_60px_rgba(37,99,235,0.15)]">
        ...
        <div className="flex-1 flex flex-col justify-between">
          ...
          <div className="mt-4 flex items-center justify-between">
            ...
            <div className="bg-white rounded-[12px] w-[35px] h-[35px] flex items-center justify-center group-hover:w-[60px] group-hover:bg-white/90 transition-all duration-300 ease-in-out hover:shadow-[0_0_20px_rgba(255,255,255,0.4)]">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="18"
                height="18"
